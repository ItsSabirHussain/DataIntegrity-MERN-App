...
import AllUsers from "./employeelist";
import Main from "./main";
import UpdateReq from "./updaterequest";
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          <div>
            ...
            <ListItem button component={Link} to="/ceodashboard/allusers">
              <ListItemIcon>
                <PermIdentityIcon fontSize="large" />
              </ListItemIcon>
              <ListItemText primary="All Users" />
            </ListItem>
            <ListItem button component={Link} to="/ceodashboard/updatereq">
              <ListItemIcon>
                <PermIdentityIcon fontSize="large" />
              </ListItemIcon>
      ...
      <Switch>
        ...
        <Route exact path="/ceodashboard/allusers" component={AllUsers} />
        <Route exact path="/ceodashboard/updatereq" component={UpdateReq} />
        <Route
          exact
